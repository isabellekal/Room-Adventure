...
class Game(Frame):
    ...
    def createRooms(self):
        ...
        r1 = Room("Intro", "Captin.gif")
        r2 = Room("Deck", "room3.gif")
        r3 = Room("Crow's Nest", "room3.gif")
        r4 = Room("Bow", "room4.gif")
        r5 = Room("Stroage", "room3.gif")
        r6 = Room("Galley", "room4.gif")
        r7 = Room("Arsenal", "room3.gif")
        r8 = Room("Captins Quarters", "room4.gif")
        r9 = Room("PoopDeck", "room2.gif")
        
        
##################################### room 1-INTRO #######################################
        
        r1.description = "Captin: Ahoy prisoner, I hope you enjoyed your nap! We allow our prisoners to be free range so feel free to explore, but there is no escape."
        r1.addExit("start", r2)
...
##################################### room 4-BOW #######################################
        ...
        r4.addExit("west", r2)
        r4.addExit("down", r5)
        r4.addExit("north", None) # DEATH! #you walked plank 
...
##################################### room 5-STORAGE #######################################
        ...
        r5.description = "You could imagine yourself reading here."
        r5.addExit("up", r4)
        r5.addExit("west", r6)
        
        r5.addGrabbable("baby hippo")
        r5.addItem("bookshelves", "They are empty. Go figure.")
        r5.addItem("statue", "There is nothing special about it.")
        r5.addItem("desk", "The statue is resting on it. So is a book.")
        Game.rooms.append(r5)
        
##################################### room 6-GALLEY #######################################
        
        r6.description = "You could imagine yourself reading here."
        r6.addExit("east", r5)
        r6.addExit("west", r7)
        
##################################### room 7-ARSENAL #######################################
        
        r7.description = "You could imagine yourself reading here."
        r7.addExit("east", r6)
        r7.addExit("west", r8)
        
##################################### room 8-CAPTINS QUARTERS #######################################
        
        r8.description = "You could imagine yourself reading here."
        r8.addExit("east", r7)
        r8.addExit("up", r9)
